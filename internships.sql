...
--
-- Host: localhost:8889
-- Generation Time: Apr 23, 2026 at 04:24 PM
...
(1, 'admin', 'สมศรี', 'ใจดี', NULL, NULL, 'admin@faculty.swu.ac.th', '$2y$10$mdWMLOd3fwxLz26Srb39c.fKjPBvDy4Ql3vJRyALKQXfJCq0knurC', NULL, '2026-03-28 01:29:03'),
...
(1, '6610501234', 'สมชาย', 'เรียนดี', 'somchai@student.swu.ac.th', '$2y$10$mdWMLOd3fwxLz26Srb39c.fKjPBvDy4Ql3vJRyALKQXfJCq0knurC', NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-28 01:29:01'),
...
(2, 'teacher1', 'สมเกียรติ', 'สอนดี', 'วิทยาการคอมพิวเตอร์', 'somkiat@email.com', '$2y$10$mdWMLOd3fwxLz26Srb39c.fKjPBvDy4Ql3vJRyALKQXfJCq0knurC', NULL, '2026-03-30 00:47:41', 'ผศ.ดร.', 'Database Management, SQL, NoSQL', 'assets/img/teachers/t1.jpg'),
(3, 'teacher2', 'วิไลวรรณ', 'ใจเย็น', 'เทคโนโลยีสารสนเทศ', 'wilaiwan@email.com', '$2y$10$mdWMLOd3fwxLz26Srb39c.fKjPBvDy4Ql3vJRyALKQXfJCq0knurC', NULL, '2026-03-30 00:47:41', 'รศ.', 'Web Development, UX/UI Design', 'assets/img/teachers/t2.jpg'),
...
--
ALTER TABLE `internships_request`
  MODIFY `request_id` int NOT NULL AUTO_INCREMENT COMMENT 'รหัสใบขอฝึกงาน', AUTO_INCREMENT=25;
...
--
ALTER TABLE `status_log`
  MODIFY `log_id` int NOT NULL AUTO_INCREMENT COMMENT 'รหัสลำดับเหตุการณ์', AUTO_INCREMENT=4;
...
--
ALTER TABLE `supervision_record`
  MODIFY `supervision_id` int NOT NULL AUTO_INCREMENT COMMENT 'รหัสลำดับการนิเทศ';
